...
public type SimplePublicObjectOk record {|
    *http:Ok;
    SimplePublicObject body;
|};
...
public type ReadPageOfContactsQueries record {
...
# Represents the Queries record for the operation: readBatchOfContactsByInternalIdOrUniquePropertyValues
public type ReadBatchOfContactsByInternalIdOrUniquePropertyValuesQueries record {
    # Whether to return only results that have been archived.
    boolean archived = false;
};
...
# Represents the Queries record for the operation: readContactById
public type ReadContactByIdQueries record {
    # A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
    string[] associations?;
    # Whether to return only results that have been archived.
    boolean archived = false;
